...
export default async function AboutPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      {/* W-ADMIN-CMS: เนื้อหาหน้านี้ดึงจาก CMS ISR — จัดการโดย Admin + BE */}
      <div className="mb-6 bg-amber-50 border border-amber-200 rounded-xl px-4 py-2.5 text-xs text-amber-800">
        🔒 เนื้อหาหน้านี้ (W-02) ดึงจากระบบ CMS อัตโนมัติ — แก้ไขโดยผู้ดูแลผ่าน Admin + ระบบหลังบ้านในจังหวะถัดไป
      </div>
      {/* Breadcrumb */}
