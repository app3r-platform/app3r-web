 ...
 * Reuse pattern: same API + UI as /disputes/page.tsx but pre-filtered service_type=A
 * Per Sub-CMD: "ไม่สร้างซ้ำ — reuse component จาก app/disputes/page.tsx"
 */
...
export default function ResellDisputesPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      // Pre-filter service_type=A (Secondhand/Resell only)
    ...
    <div className="flex min-h-screen bg-gray-950 text-white">
      ...
      <main className="flex-1 p-8 min-w-0">
        ...
        <div className="flex items-center justify-between mb-1">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              ข้อพิพาท Resell (มือสอง) เท่านั้น — service_type A
            </p>
          </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 my-5 text-sm">
          <p className="text-gray-400 mb-2 font-medium">กฎการตัดสิน (Resell):</p>
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-blue-950 border border-blue-800 rounded-lg p-3">
              ...
              <div className="text-xs text-gray-400">คืน escrow เต็มจำนวนให้ buyer · listing → CANCELLED</div>
            </div>
            <div className="bg-green-950 border border-green-800 rounded-lg p-3">
              ...
              <div className="text-xs text-gray-400">โอน escrow ให้ seller · ไม่หัก platform fee · listing → COMPLETED</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-gray-500">
              ...
              <p className="text-lg font-medium text-white mb-1">ไม่มีข้อพิพาท Resell ที่รอตัดสิน</p>
              <p className="text-sm">Resell listings ทั้งหมดอยู่ในสภาพปกติ</p>
            </div>
          ) : (
      ...
      {resolveModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            <h3 className="text-xl font-bold mb-1">ตัดสินข้อพิพาท Resell</h3>
