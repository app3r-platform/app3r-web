    ...
    <div className="flex min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="flex-1 p-8 min-w-0">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 my-5 text-sm">
          <p className="text-gray-500 mb-2 font-medium">กฎการตัดสิน (Resell):</p>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-green-950 border border-green-800 rounded-lg p-3">
              ...
              <div className="text-xs text-gray-500">โอน escrow ให้ seller · ไม่หัก platform fee · listing → COMPLETED</div>
            </div>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-200">
                {data.items.map(item => (
                  <tr key={item.listing_id} className="hover:bg-gray-100">
