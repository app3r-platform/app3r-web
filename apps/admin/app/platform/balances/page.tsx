          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                <BucketCard label="กองทุนค่าประกาศ" value={fmtG(data.listing_offer_fee_pool)} accent="yellow" />
                <BucketCard label="กองทุนค่าแพลตฟอร์ม" value={fmtG(data.platform_fee_pool)} accent="yellow" />
                <BucketCard label="กองทุนโฆษณา" value={fmtG(data.advertising_pool)} accent="admin-primary" />
                <BucketCard label="พักเงินกลาง (Escrow)" value={fmtG(data.escrow_pool)} accent="blue" />
