...
const ACTION_CONFIG: Record<OverrideAction, {
  ...
  cancel: {
    ...
    axes: [
      ...
      { key: "timeline",     icon: "⏱️", implication: "งานสิ้นสุดก่อนกำหนด — ช่วงยกเลิกมีผลต่อพอยต์ทองที่ล็อก" },
    ],
  },
  refund: {
    label:    "Force Refund",
    ...
    axes: [
      ...
      { key: "deposit",  icon: "💳", implication: "override นโยบายพอยต์ทองที่ล็อก — คืนพอยต์ทองที่ล็อก 100%" },
