...
export function SheetContent({ children }: { children: ReactNode }) {
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        className="fixed right-0 top-0 z-50 h-full w-[480px] max-w-full bg-white border-l border-gray-200 text-white shadow-xl flex flex-col data-[state=open]:translate-x-0 data-[state=closed]:translate-x-full transition-transform duration-300 focus:outline-none"
      >
        {children}
      </Dialog.Content>
    </Dialog.Portal>
