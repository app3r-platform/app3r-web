...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: "Maintain",
    items: [
      { href: "/maintain/jobs",      label: "Jobs",            icon: "🛁" },
      { href: "/maintain/recurring", label: "Recurring",       icon: "🔁" },
      { href: "/maintain/analytics", label: "Analytics",       icon: "📊" },
    ],
  },
  {
    label: "Parts",
    items: [
      { href: "/parts",              label: "Inventory",       icon: "🔩" },
      { href: "/parts/movements",    label: "Movements",       icon: "📦" },
      { href: "/parts/analytics",    label: "Analytics",       icon: "📊" },
    ],
  },
  {
    label: "Resell",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/testimonials",             label: "รีวิวลูกค้า",           icon: "⭐" }, // D-num: D86
