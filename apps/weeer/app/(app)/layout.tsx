...
const navItems = [
  ...
  { href: "/resell/marketplace", icon: "🛒", label: "  ตลาดซื้อขาย (Marketplace)", module: true, sub: true },
  ...
  { href: "/repair/walk-in/queue",  icon: "🚶", label: "  คิวหน้าร้าน (Walk-in)",  module: true, sub: true },
  { href: "/repair/pickup/queue",   icon: "🚛", label: "  คิวรับถึงที่ (Pickup)",   module: true, sub: true },
  { href: "/repair/parcel/queue",   icon: "📦", label: "  คิวพัสดุ (Parcel)",   module: true, sub: true },
