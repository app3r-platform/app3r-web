  ...
  return (
    <div>
      ...
      <select
        ...
        disabled={disabled}
        className="w-full text-sm border border-gray-200 rounded-xl px-3 py-2.5 bg-white focus:outline-none focus:ring-2 focus:ring-[#FF663A] disabled:opacity-50 disabled:cursor-not-allowed"
      >
