"use client";
// C3 — U-40 ลงประกาศขายสำเร็จ
import { useMemo } from "react";
import { useRouter } from "next/navigation";

export default function SellNewSuccessPage() {
    ...
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-base font-semibold text-weeeu-primary">ลงประกาศขายสำเร็จ</p>
          <p className="text-sm text-gray-500">ประกาศของคุณถูกสร้างแล้ว ผู้สนใจจะติดต่อผ่านระบบ</p>
        </div>
