"use client";
// C6 — U-43 ยื่น Dispute สำเร็จ
import { useMemo } from "react";
import { useParams, useRouter } from "next/navigation";

export default function PurchaseDisputeSuccessPage() {
    ...
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-base font-semibold text-weeeu-primary">ยื่น Dispute สำเร็จ</p>
          <p className="text-sm text-gray-500">การร้องเรียนของคุณถูกบันทึกแล้ว ทีม Admin จะตรวจสอบภายใน 3 วันทำการ</p>
          {params.id && (
            <p className="text-xs text-gray-400">งาน #{params.id}</p>
          )}
        </div>
