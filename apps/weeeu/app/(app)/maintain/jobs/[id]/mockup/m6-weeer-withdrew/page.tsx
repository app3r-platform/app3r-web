 ...
 *  3. ถ้ายกเลิก: แสดง settle ตาม offer lock (เงินค้ำประกัน/ค่าเดินทางที่ WeeeR เคยระบุ)
 *
    ...
    <div className="max-w-xl space-y-5">
            ...
            <div className="bg-white border border-red-100 rounded-xl p-3 space-y-1">
              ...
              {JOB.offerLock.depositAmount > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">เงินค้ำประกัน (WeeeR รับไว้)</span>
              ...
              <p className="text-xs text-gray-400 pt-1">
                * WeeeR ถอนเป็นผู้ผิด → คืนเงินค้ำประกัน + WeeeR ไม่ได้ค่าเดินทาง (policy นโยบาย)
              </p>
            </div>
          )}
          ...
          {action === "cancel_confirm" && (
            <div className="bg-white border border-red-200 rounded-xl p-4 space-y-3">
              ...
              <p className="text-xs text-gray-500">
                ระบบจะ settle เงินค้ำประกัน {JOB.offerLock.depositAmount} พอยต์ทอง คืนให้คุณ
      ...
      {action === "cancelled" && (
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 text-center space-y-2">
          ...
          <p className="text-sm text-gray-500">เงินค้ำประกัน {JOB.offerLock.depositAmount} พอยต์ทอง จะคืนภายใน 1-3 วันทำการ</p>
        </div>
      )}
